...
const team = [
  {
    title: 'STARTER',
    amount: '$ 500',
    benefits: ['Instant Trading', 'Demo Trading', 'Pro Broker', 'Min $10,000', 'Max $40,999'],
  },
  {
    title: 'BASIC',
    amount: '$ 5,000',
      ...
      <div className="grid grid-cols-1 w-full bg-gradient-to-r from-blue-800 to-cyan-500">
        <div className=''>
          <div className='bg-gradient-to-r from-blue-800 to-cyan-500'>
            <div className={`fixed w-full z-10 ${scroll ? "bg-gray-100 shadow-lg border-b" : " "}`}>
      ...
      <div className="my-16">
        <div className="">
          <div className="text-center">
            <h1 className="text-4xl text-blue-800">Investment Plans</h1>
            <p className="text-gray-600">Bitcoin is the simplest way to exchange money at very low cost.</p>
          </div>
        </div>
        <div className="bg-gray-100 flex items-center mb-20 justify-center mt-10">
          <div className="lg:flex items-center justify-center mx-10 my-6 gap-10 grid md:grid-cols-2">
            {team.map((item, i) => (
              <div key={i} className="bg-white rounded-xl flex text-center items-start justify-center w-[16rem] py-4 h-[20rem] shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
                <div className="">
                  <div className=" border-b my-4 pb-2"> {item.title} </div>
                  <div className="text-center mb-6">
                    <h1 className="text-2xl mb-7 text-center"> {item.amount} </h1>
                    <div className="mb-10">
                      <p className="">Instant Trading</p>
                      <p className="">Demo Trading</p>
                    </div>
                  </div>
                  <div className="border py-4 w-[10rem] text-center text-white font-semibold rounded-full bg-gradient-to-l from-cyan-500 to-blue-500 shadow-md transition duration-300 ease-in-out transform hover:scale-105">
                    <Link to='/login' className=''>Select Plan</Link>
                  </div>
                </div>
              </div>
            ))}
